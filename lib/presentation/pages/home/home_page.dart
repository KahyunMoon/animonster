                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      height: 300,
                      child:
                          Image.asset('assets/images/00012-4230116629-1.png'),
                    ),
                    const Padding(
                      padding: EdgeInsets.all(10),
                      child: Text(
                          ...
                          children: [
                            ...
                            const Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 10),
                                Expanded(
                                  child: Text('롤플레이를 즐기면서 내 캐릭터 능력치도 업! 업!'),
                                ),
                              ],
                            ),
                            const Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 10),
                                Expanded(
                                  child: Text('원작 캐릭터 보다 더 매력적인 나만의 캐릭터 육성'),
                                ),
                              ],
                            ),
                            const SizedBox(height: 10),
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 10),
                      child: Image.asset('assets/images/INFO_-655x1024.png'),
                    ),
                    Container(
                      color: Colors.grey,
                              ...
                              children: [
                                ...
                                TextSpan(
                                  ...
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontWeight:
                                        FontWeight.bold, // BmineAI 부분에 bold 적용
                                  ),
                                ),
                                TextSpan(
